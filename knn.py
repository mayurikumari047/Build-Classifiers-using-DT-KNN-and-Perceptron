...
class KNN(BinaryClassifier):
    ...
    def predict(self, X):
        ...
        if self.trY.size == 0:
            ...
            sorted_dist_indices = argsort(dist)
            val = util.mode(self.trY[sorted_dist_indices[0:K]])
            #print("dist:",dist," sorted_dist_indices:",sorted_dist_indices," val:",val)
